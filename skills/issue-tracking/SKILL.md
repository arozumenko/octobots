...
**Every meaningful action gets a comment on the issue.** Read `shared/conventions/audit-trail.md` for the full convention.

Quick reference — comment when you:
...
See `shared/conventions/audit-trail.md` for the full audit trail convention.
